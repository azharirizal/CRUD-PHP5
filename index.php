...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg">PHP 5.5</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        ...
        <!-- User Account: style can be found in dropdown.less -->
          <?php
          $queryadmin = mysql_query("SELECT * FROM admin WHERE id_admin='$_SESSION[id_admin]'");
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">              
              ...
              <span class="hidden-xs"><?php echo $rowadmin['username']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
              <img src="img/profil/<?php echo $rowadmin['profil']; ?>" class="img-circle" alt="User Image">
                <p><?php echo $rowadmin['nama']; ?><small>Sebagai Administrator</small>
                </p>
              </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $rowadmin['username']; ?></p>
